    ...
    <div class="fondo-section">
        <div class="container section black-text">
            ...
            <div class="section">
                ...
                echo ' <div class="row black white-text">
                            <div class="col s12 m4 l6"><p>Medición</p></div>
                            <div class="col s12 m4 l6"><p>Fecha</p></div>
                        </div>';
                    ...
                    echo '<a href="grafica.php?pozo=' . $ver . '"
                         class="waves-effect waves-light btn black">Gráfica</a>
                         
                         <a href="index.php" class="waves-effect waves-light btn black">Volver</a>';
